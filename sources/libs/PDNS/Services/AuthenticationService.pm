...
# https://akscf.me/
# ******************************************************************************************
package PDNS::Services::AuthenticationService;
...
sub rpc_login {
	...
	my $admin_name = $self->{pmod}->get_config('users', 'admin_name');
	my $admin_pass = $self->{pmod}->get_config('users', 'admin_secret');
	my $admin_enable = $self->{pmod}->get_config('users', 'admin_enable');
